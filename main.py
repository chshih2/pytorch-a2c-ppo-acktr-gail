...
def main():
    ...
    if args.load:
        ...
        #exit()
        #.state_dict()
        actor_critic, agent.optimizer, start_epoch = load_checkpoint(actor_critic, agent.optimizer,os.path.join(save_path, args.env_name + ".pt"))
    ...
    for j in range(start_epoch,num_updates):
        ...
        if (j % args.save_interval == 0
            ...
            try:
                ...
                pass
            state = {'epoch': j + 1, 'state_dict': actor_critic.state_dict(),
